                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            @else
                                ...
                                @if($row->field == "content")
                                    ...
                                    @foreach(json_decode($dataTypeContent->content) as $content)

                                        <p style="font-weight: bold;">{{ $content->label }}</p>
                                ...
                                @elseif($row->field == "address_user_id")
                                    ...
                                    @php
                                        ...
                                        $address = getAddressById($dataTypeContent->address_user_id);

                                    @endphp

                                    <p>{{ $address->street }} - {{ $address->zip_code }} - {{ $address->locality }}</p>
