<input required="" type="text" class="form-control" name="ids[]" placeholder="Ids" value="no_attr" style="display: none;" readonly>
    ...
    <div id="value_end" class="form-group  col-md-4">
        ...
        <input required="" type="text" id="value_end" class="form-control" onkeyup="calculatePercentageWithValueEndNoAttr(this)" name="value_end[]" placeholder="Valor Final" value="{{ $values[$price_value] }}">

        <input required="" type="number" id="value_origin" class="form-control" name="value_origin[]" placeholder="Valor Original" value="{{ $values[$price_value] }}" style="display: none;" readonly>
