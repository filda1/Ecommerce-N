...
<p style="font-size: 14px; line-height: 16px; margin: 0;"><strong><span style="font-size: 46px; line-height: 55px;">Bem Vindo, <span style="color: #ff8300; line-height: 55px; font-size: 40px;">{{ explode("@", $email)[0] }}</span></span></strong></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 12px; line-height: 18px; margin: 0;"><strong><span style="font-size: 20px; line-height: 30px;">Obrigado por confiar no nosso serviço, antes de poder continuar precisa no entanto de confirmar este endereço de email.</span></strong></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<a href="{{ secure_url('confirmar-email', $user_message) }}">
<strong>Confirmar Conta</strong>
</a>
