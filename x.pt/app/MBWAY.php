...
class MBWAY
{
    ...
    public function gerarReferencia($user_id, $chave_api, $nota_de_encomenda, $valor_da_encomenda, $alias, $pedido_id = null)
    {
        $compra = new Transaco();
        ...
        curl_setopt($ch, CURLOPT_URL, $this->urlAPIEupago."/mbway/create");
        curl_setopt($ch, CURLOPT_POST, 1);
        curl_setopt($ch, CURLOPT_POSTFIELDS,
                    "chave=" . $chave_api . "&valor=" . $valor_da_encomenda . "&id=" . $nota_de_encomenda . "&alias=" . $alias);
